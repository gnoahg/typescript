...
class Client extends discord_js_1.Client {
    ...
    async initGuildApplicationCommands(guildId, DCommands, options) {
        ...
        await Promise.all(ApplicationCommands.map(async (cmd) => {
            ...
            const guilds = await (0, index_js_1.resolveIGuilds)(this, DCommandx, [
                ...botResolvedGuilds,
                ...DCommandx.guilds,
            ]);
    ...
    async executeButtonInteraction(interaction, log) {
        ...
        const guilds = [];
        if (button) {
            guilds.push(...(await (0, index_js_1.resolveIGuilds)(this, button, [
                ...botResolvedGuilds,
                ...button.guilds,
            ])));
        }
    ...
    async executeSelectMenu(interaction, log) {
        ...
        const guilds = [];
        if (menu) {
            guilds.push(...(await (0, index_js_1.resolveIGuilds)(this, menu, [
                ...botResolvedGuilds,
                ...menu.guilds,
            ])));
        }
