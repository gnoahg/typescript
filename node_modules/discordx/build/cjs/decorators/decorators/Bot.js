...
function Bot(...botIds) {
    return function (target, key, descriptor) {
        ...
        }, index_js_1.DApplicationCommand, index_js_1.DSimpleCommand, index_js_1.DDiscord, index_js_1.DComponentButton, index_js_1.DComponentSelectMenu, index_js_1.DOn).decorateUnknown(target, key, descriptor));
    };
}
exports.Bot = Bot;
