import type { ApplicationCommandPermissionData, Guild, GuildChannel, GuildMember, Role, ThreadChannel, User } from "discord.js";
import type { ArgSplitter, DSimpleCommandOption, IDefaultPermission, IGuild, IPermissions, IPrefix, SimpleCommandMessage, SimpleCommandOptionType } from "../../index.js";
...
export declare class DSimpleCommand extends Method {
    ...
    parseParamsEx(command: SimpleCommandMessage, splitter?: ArgSplitter): (string | number | boolean | ThreadChannel | GuildChannel | User | GuildMember | Role | null | undefined)[];
}
