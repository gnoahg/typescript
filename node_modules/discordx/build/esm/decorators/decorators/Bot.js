...
import { DApplicationCommand, DComponentButton, DComponentSelectMenu, DDiscord, DOn, DSimpleCommand, MetadataStorage, } from "../../index.js";
export function Bot(...botIds) {
    return function (target, key, descriptor) {
        ...
        }, DApplicationCommand, DSimpleCommand, DDiscord, DComponentButton, DComponentSelectMenu, DOn).decorateUnknown(target, key, descriptor));
    };
}
